...
class Commander:
    _BOT_URL = "https://api.telegram.org/bot471505208:AAHs8IFgDdYwVLnPzAvAm4SOGBJVixO6QSI/"
    last_update_id = 0
    ...
    def send_gild_photo(self, chat_id=AKSELIN_CHAT_ID):
        ...
        url = self._BOT_URL + "sendPhoto?chat_id=" + chat_id + "&photo=" + "http://tietojohtajakilta.net/webcam/cam_1.jpg" + timestamp
    ...
    def send_message(self, message, chat_id= AKSELIN_CHAT_ID):
